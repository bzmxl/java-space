...
public class KafKaConfig {
    ...
    @Bean
    public ConsumerFactory<String, KafkaMsg> getConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(KafkaMsg.class));
    }
